# Magento 2 Custom Option Absolute Price Extension

[Magento 2 Custom Option Absolute Price](https://www.ulmod.com/custom-options-absolute-price-for-magento-2.html)  is a Magento 2 extension that  is a Magento 2 extension that
add absolute price type to the default Magento 2 customizable options.
...
* Support absolute price type in customizable options
* Work with any product option type: radio buttons, checkbox, drop-down, and multiple select
* Work with all product types
* Show selected absolute price at shopping cart page, checkout page, and order view page in the backend
* Mobile-friendly
* Support multiple-stores


<img src="https://www.ulmod.com/media/ulmod/product_content/asbp-p-main.png">
<img src="https://www.ulmod.com/media/ulmod/product_content/asbp-p-admin.png">
